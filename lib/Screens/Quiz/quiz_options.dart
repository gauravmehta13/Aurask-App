...
import 'package:aurask/Screens/Quiz/error.dart';
import 'package:aurask/Screens/Quiz/quiz_page.dart';
import 'package:aurask/models/category.dart';
import 'package:aurask/models/question.dart';
import 'package:aurask/resources/api_provider.dart';
            ...
            child: Wrap(
              ...
              children: <Widget>[
                ...
                ActionChip(
                  ...
                  labelStyle: TextStyle(color: Colors.white),
                  backgroundColor:
                      _difficulty.isEmpty ? primaryColor : Colors.grey.shade600,

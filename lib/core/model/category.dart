...
final List<Category> categories = [
  ...
  Category(20, "Mythology", icon: FontAwesomeIcons.star),
  ...
  Category(24, "Politics", icon: FontAwesomeIcons.poll),
  Category(25, "Art", icon: FontAwesomeIcons.paintBrush),
  Category(26, "Celebrities", icon: Icons.celebration),
  Category(27, "Animals", icon: FontAwesomeIcons.dog),
  Category(28, "Vehicles", icon: FontAwesomeIcons.carAlt),
  Category(29, "Comics", icon: FontAwesomeIcons.book),
  Category(30, "Gadgets", icon: FontAwesomeIcons.mobileAlt),
  Category(31, "Japanese Anime & Manga", icon: Icons.book_online_sharp),
